...
private struct SettingsCard<Content: View>: View {
    ...
    var body: some View {
        ...
        .background(JottrTheme.surface)
        .cornerRadius(10)
        .overlay(
            RoundedRectangle(cornerRadius: 10)
                .stroke(JottrTheme.amber.opacity(0.08), lineWidth: 1)
        )
    }
}
        ...
        Button(action: action) {
            HStack {
                Image(systemName: isSelected ? "checkmark.circle.fill" : "circle")
                    .foregroundColor(isSelected ? JottrTheme.amber : .secondary)
            ...
            .padding(12)
            .background(isSelected ? JottrTheme.amber.opacity(0.12) : JottrTheme.surface)
            .animation(.easeInOut(duration: 0.15), value: isSelected)
            .cornerRadius(8)
            .overlay(
                ...
                .overlay(alignment: .topTrailing) {
                    Button {
                        ...
                        Image(systemName: showHelp ? "questionmark.circle.fill" : "questionmark.circle")
                            .foregroundColor(showHelp ? JottrTheme.amber : .secondary)
    ...
    var body: some View {
        VStack(spacing: 0) {
            if isEditing {
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    HStack {
                        Image(systemName: "pencil.circle.fill")
                            .foregroundColor(JottrTheme.amber)
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: 8)
                        .stroke(JottrTheme.amber.opacity(0.4), lineWidth: 1)
                )
                .onAppear {
        ...
        VStack(spacing: 0) {
            HStack {
                VStack(alignment: .leading, spacing: 2) {
                    Text("Run Log")
                        .font(.headline)
                    Text("Stored locally, never shared. Only the \(appState.maxPipelineHistoryCount) most recent runs are kept.")
                        .font(.caption)
    ...
    var body: some View {
        HStack(alignment: .top, spacing: 10) {
            Text("\(number)")
                ...
                .background(Circle().fill(JottrTheme.amber))
        ...
        .padding(10)
        .background(JottrTheme.surface.opacity(0.7))
        .cornerRadius(8)
    }
}
        ...
        HStack(spacing: 10) {
            Button {
                ...
                Image(systemName: isPlaying ? "stop.fill" : "play.fill")
                    .font(.body)
                    .frame(width: 28, height: 28)
                    .background(Circle().fill(JottrTheme.amber.opacity(0.15)))
                    .contentShape(Circle())
            }
            .buttonStyle(.plain)
