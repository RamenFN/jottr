...
final class UpdateManager: ObservableObject {
    ...
    private let releasesURL = URL(string: "https://api.github.com/repos/RamenFN/jottr/releases/latest")!
    ...
    func checkForUpdates(userInitiated: Bool) async {
        let currentBuildTag = Bundle.main.infoDictionary?["JottrBuildTag"] as? String
    ...
    func showUpdateAlert() {
        ...
        alert.informativeText = "A new version of Jottr (released \(latestReleaseDate)) is available.\n\nWould you like to download the update?"
    ...
    private func showRecentReleaseAlert(daysSincePublished: Double) {
        ...
        alert.informativeText = "A new version of Jottr was released \(ageText). It's very recent — you can download it now or wait a few days for stability.\n\nWould you like to download it?"
        alert.alertStyle = .informational
        alert.icon = NSApp.applicationIconImage
    ...
    func showUpToDateAlert() {
        ...
        alert.informativeText = "You're running the latest version of Jottr."
        alert.alertStyle = .informational
        alert.icon = NSApp.applicationIconImage
    ...
    private func performUpdate(downloadURL: URL, expectedSize: Int) async {
        ...
        let tempDir = fm.temporaryDirectory.appendingPathComponent("jottr-update-\(UUID().uuidString)")
        ...
        let dmgPath = tempDir.appendingPathComponent("Jottr.dmg")
        ...
        do {
            ...
            let stagingDir = fm.temporaryDirectory.appendingPathComponent("jottr-staged-\(UUID().uuidString)")
